...
Dois processos centrais do sistema foram modelados como fluxos de atividade. Os diagramas estão em [`diagramas/`](../diagramas/).
...
O diagrama completo está em [`diagramas/diagrama-classes.pdf`](../diagramas/diagrama-classes.pdf).
...
Diagrama completo em [`banco-de-dados/modelo-conceitual-mer.pdf`](../banco-de-dados/modelo-conceitual-mer.pdf).
...
Diagrama completo em [`banco-de-dados/modelo-logico.pdf`](../banco-de-dados/modelo-logico.pdf).
...
O script SQL de criação das tabelas está em [`banco-de-dados/schema.sql`](../banco-de-dados/schema.sql).
